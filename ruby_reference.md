...
##Basics
_$ irb –– to write ruby in the terminal_
_don't use ' in ruby, use " instead_
_you can replace most {} with do end and vice versa –– not true for hashes or #{} escapings_
_Best Practice: end names that produce booleans with question mark_
_CRUD: create, read, update, delete_
_[1,2].map(&:to_i)_
_integer = number without decimal || float = number with decimal_
_tag your variables: $ = global, @ = instance, @@ = class variable_
_1_000_000 = 1000000 –– just easier to read_
